...
import com.eastcom.aggregator.interfaces.dto.JobEntity;
...
@Component
@Scope("prototype")
public class JobEntityImpl implements JobEntity<SparkJobs> {
    ...
    private SparkJobs tableEntity;

    public JobEntityImpl(String jobName, SparkJobs tableEntity) {
