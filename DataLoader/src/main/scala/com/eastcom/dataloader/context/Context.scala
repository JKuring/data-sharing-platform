...
object Context {
  ...
  /**
    ...
    * @return
    */
  def getSql( configServiceUrl: String, tplname: String, node: SlsNode ): String = {
    ...
    // http
    var tpl: String = HttpRequestUtils.httpGet(configServiceUrl + node.getTplCiCode , "".getClass).split("\\n").mkString(" \n")
