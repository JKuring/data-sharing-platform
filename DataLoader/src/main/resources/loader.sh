...
VM_FLAG="-Xmx2G -Djava.library.path=/home/ipms/hadoopclient/hadoop/lib/native -Dauth.config.path=conf/hbase/auth/ -Dzookeeper.sasl.clientconfig=client -Dzookeeper.server.principal=zookeeper/hadoop.hadoop_b.com -Dhadoop.user.root.path=/user/east_wys"
